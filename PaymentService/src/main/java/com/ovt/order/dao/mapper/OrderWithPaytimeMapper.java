 ...
 */
public class OrderWithPaytimeMapper implements RowMapper<Order>
{
    @Override
    public Order mapRow(ResultSet rs, int rowNum) throws SQLException
    {
        ...
        order.setPayTime(rs.getTimestamp(ORDER.PAY_TIME));
