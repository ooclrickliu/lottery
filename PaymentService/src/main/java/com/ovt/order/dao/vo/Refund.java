...
public class Refund extends BaseEntity
{
    ...
    public String toString()
    {
        return "Refund [refundRequestId=" + refundRequestId + ", batchNo="
                ...
                + ", refundState=" + refundState + ", refundTax=" + refundTax
                + ", refundTaxState=" + refundTaxState + ", refundTime="
                + refundTime + ", refundLogId=" + refundLogId + ", createTime="
                + createTime + ", id=" + id + ", updateTime=" + updateTime
                + ", isDelete=" + isDelete + "]";
    }
