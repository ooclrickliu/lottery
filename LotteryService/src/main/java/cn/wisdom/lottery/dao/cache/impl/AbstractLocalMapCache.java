 ...
 * May 27, 2015
 */
package cn.wisdom.lottery.dao.cache.impl;
...
import cn.wisdom.lottery.common.model.LRUMap;
import cn.wisdom.lottery.common.utils.CollectionUtils;
import cn.wisdom.lottery.dao.cache.LocalCacheManager;
import cn.wisdom.lottery.dao.cache.MapCache;
...
public abstract class AbstractLocalMapCache<K, V> implements MapCache<K, V>
{
    ...
    /* (non-Javadoc)
     * @see cn.wisdom.lottery.dao.cache.Cache#preLoad()
     */
    @Override
    public void preLoad()
    {
