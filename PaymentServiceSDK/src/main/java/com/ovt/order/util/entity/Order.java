...
public class Order extends BaseEntity
{
    ...
    {
        return "Order [orderNo=" + orderNo + ", orderState=" + orderState
                + ", orderTotalFee=" + orderTotalFee + ", refundedFee="
                + refundedFee + ", userId=" + userId + ", userName=" + userName
                + ", createBy=" + createBy + ", creatorName=" + creatorName
                + ", orderRemark=" + orderRemark + ", isDelete=" + isDelete
                + ", extra1=" + extra1 + ", extra2=" + extra2 + ", extra3="
                + extra3 + ", orderItemList=" + orderItemList + ", payTime="
                + payTime + ", refundTime=" + refundTime + "]";
    }
