    ...
    compile: function uiJqCompilingFunction(tElm, tAttrs) {
      ...
      return function uiJqLinkingFunction(scope, elm, attrs) {
        ...
        if (attrs.uiOptions) {
          ...
          //if (angular.isObject(options) && angular.isObject(linkOptions[1])) {
          //  linkOptions[1] = angular.extend({}, options, linkOptions[1]);
          //}
        } else if (options) {
          linkOptions = [options];
        }
        ...
        function callPlugin() {
          $timeout(function() {
            //console.log(linkOptions[0][0].data);
        ...
        if (attrs.uiRefresh) {
          scope.$watch(attrs.uiRefresh, function() {
            linkOptions[0][0].data = scope.$eval(attrs.uiRefresh).data;
            linkOptions[1].xaxis.autoscaleMargin = scope.$eval(attrs.uiRefresh).boolean;
            linkOptions[1].xaxis.ticks = scope.$eval(attrs.uiRefresh).ticks;
            linkOptions[1].yaxis.tickFormatter = scope.$eval(attrs.uiRefresh).tickFormatter;
            //linkOptions[1].xaxis.ticks = scope.$eval(attrs.uiRefresh).ticks;
            callPlugin();
          });
        }
 ...
 */
angular.module('ui.modify',[]).value('uiResetConfig',null).directive('uiReset', ['uiResetConfig', function (uiResetConfig) {
  var resetValue = null;
