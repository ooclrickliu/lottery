...
angular.module('ngAnimate', ['ng'])
 ...
 function($delegate,   $$q,   $injector,   $sniffer,   $rootElement,   $$asyncCallback,   $rootScope,   $document,   $templateRequest) {
    ...
    $animateProvider.register('', ['$window', '$sniffer', '$timeout', '$$animateReflow',
      ...
      // Also, the only modern browser that uses js prefixes for transitions/keyframes is webkit
      // therefore there is no reason to test anymore for other js prefixes: http://caniuse.com/#search=transition
